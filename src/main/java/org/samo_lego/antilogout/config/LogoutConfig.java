...
public class LogoutConfig implements IBrigadierConfigurator {
    ...
    public static class General {
        @SerializedName("// Time in seconds that player's body stays online after disconnect (0 to disable)")
        public final String _comment_logoutGracePeriod = "";
        @SerializedName("logout_grace_period")
        public double logoutGracePeriod = 0.0D;
    }
